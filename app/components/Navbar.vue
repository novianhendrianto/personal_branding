...
<template>
  <header class="sticky top-0 z-40 border-b border-slate-700/60 bg-[#111827] backdrop-blur-md">
    <nav class="section-wrap flex h-16 items-center justify-between">
      <a href="#home" class="brand-heading text-base font-bold tracking-tight text-white sm:text-lg">
        Novian<span class="text-[#ffb020]">.</span>Architecture
      </a>

      <ul class="hidden items-center gap-5 text-sm font-medium text-white/90 md:flex">
      ...
      <a
        href="https://wa.me/6281234567890?text=Halo%20Pak%20Novian,%20saya%20ingin%20diskusi%20solusi%20IT"
        target="_blank"
        rel="noopener noreferrer"
        class="rounded-full bg-gradient-to-r from-[#ffb020] to-[#ff8f00] px-5 py-2 text-xs font-semibold text-slate-900 shadow-[0_4px_14px_rgba(255,159,28,0.45)] transition hover:shadow-[0_4px_20px_rgba(255,159,28,0.6)] hover:brightness-105 sm:text-sm"
      >
        Konsultasi Gratis
      </a>
    </nav>
